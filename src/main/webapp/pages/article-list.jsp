                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建"
                                            onclick='window.location="${pageContext.request.contextPath}/pages/article-add.jsp"'>
                        ...
                        <table id="dataList"
                            ...
                            <c:forEach items="${articles}" var="article">
                                <tr>
                                    ...
                                    <td>${article.id}
                                        <input style="display: none" name="id" type="text" value="${article.id}">
                                    </td>
                                    <td>
                                        <input type="text" name="title" class="form-control" disabled    value="${article.title}"/>
                                    </td>
                                    <td>
                                        <input type="text"  name="article-type" class="form-control" disabled="disabled" value="${article.articleTypeId}"/>
                                    </td>
                                    <td>
                                        <input name="productId" type="text"  class="form-control" disabled="disabled"  value="${article.content}"/>
                                    </td>
...
<%--                                    <td style="padding-top:40px">${pic.createData}</td>--%>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick='window.location="${pageContext.request.contextPath}/article/getById"+"?id=${article.id}"'>详情
                                        </button>
                                        <button style="display: none" type="button" class="btn bg-fuchsia btn-xs"
