                    ...
                    <div class="row data-type">
                        ...
                        <div class="box-success">
                            ...
                            <div class="box-body pad">
                                ...
                                <textarea id="surfaceImgArea" class="textarea" name="surfaceImg" placeholder="在工具栏中点击图片logo传入图片url,图片将在此回显"
                        ...
                        <div class="box-success">
                            ...
                            <div class="box-body pad">
                                ...
                                <textarea id="slideImgArea" class="textarea" name="slideImg" placeholder="在工具栏中点击图片logo传入图片url,图片将在此回显"
                                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="box-success">
                            ...
                            <div class="box-body pad">
                                ...
                                <textarea id="introImgArea" class="textarea" name="introImg" placeholder="在工具栏中点击图片logo传入图片url,图片将在此回显"
                                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                            </div>
                        </div>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            success:function(e){
                ...
                for(x in e){
                    select.append("<option value='"+e[x].id+"'>"+e[x].name+"</option>")
                }
            }
        })
    });
