...
<div class="wrapper">
    ...
    <div class="content-wrapper">
            ...
            <section class="content"> <!--商品信息-->
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input id="confirmPassword" type="password" class="form-control" name=""
                                   placeholder="密码" value="">
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <select id="roles" multiple="roles" class="form-control select2" style="width: 100%"
                                    name="roles">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <input id="inputurl0" type="text" class="form-control"
                                                                       placeholder="" name="profileImg" value="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div class="box-tools text-center">
            ...
            <button type="submit" class="btn bg-maroon" onclick="send();return false;">添加</button>
    ...
    $(document).ready(function () {
        $.ajax({
            ...
            success: function (e) {
                ...
                for (x in e) {
                    select.append(
                        "<option value='" + e[x].id + "'>" + e[x].role + "</option>"
                    )
                }
            }
        })
