						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/pages/staff-add.jsp'">
										...
										<tr>
											...
											<td>
												<select id="producttype" class="form-control select2" style="width: 100%"
													...
													<c:forEach items="${staff.authorities}" var="a">
														<option>${a}</option>
													</c:forEach>
												</select>
											</td>
