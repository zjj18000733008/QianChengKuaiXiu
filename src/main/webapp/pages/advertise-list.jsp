...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                广告管理 <small>全部广告</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="${pageContext.request.contextPath}/index.jsp"><i
                        class="fa fa-dashboard"></i> 首页</a></li>
                <li><a
                        href="${pageContext.request.contextPath}/">广告管理</a></li>

                <li class="active">全部广告</li>
            </ol>
        </section>
        <!-- 内容头部 /-->
...
<%--                                    </button>--%>
                        ...
                        <table id="dataList"
                            ...
                            <tbody>
                            <c:forEach items="${homepagePictures}" var="pic">
                                <tr>
                                    <td><input name="id" type="checkbox" value="${pic.id}"></td>
                                    <td>${pic.id}
                                        <input style="display: none" name="id" type="text" value="${pic.id}">
                                    </td>
                                    <td>
                                        <img src="${pic.url}" height="100px" width="220px"/>
                                    </td>
                                    <td>
                                        <input type="text" style="margin-top:30px" name="url" class="form-control" disabled="disabled" value="${pic.url}"/>
                                    </td>
                                    <td>
                                        <input name="productId" type="text" style="margin-top:30px" class="form-control" disabled="disabled" value="${pic.productId}"/>
                                    </td>
                                    <td style="padding-top:38px">
                                        <select class="select2" name="type" style="width: 80px" disabled>
                                    ...
                                    <td style="padding-top:40px">${pic.createData}</td>
                                    <td style="padding-top:38px">
                                        <select  class="select2" name="state" style="width: 80px" disabled>
                                            <c:if test="${pic.state==1}">
                                                <option value="1" selected>发布</option>
                                                <option value="0" >不发布</option>
                                            </c:if>
                                            <c:if test="${pic.state==0}">
                                    ...
                                    <td class="text-center">
                                        <button style="margin-top:30px" type="button" class="btn bg-olive btn-xs"
                                                onclick='modify(this)'>修改
                                        </button>
                                        <button style="margin-top:30px;display: none" type="button" class="btn bg-fuchsia btn-xs"
...
<script>
    ...
    function send(obj){
        ...
        $.ajax({
            url:'${pageContext.request.contextPath}/homepage/picture/update',
            data:str,
            success:function(e){
                alert(e)
                window.location.reload()
    ...
    function deleteInBatch() {
        ...
        $.ajax({
            url: '${pageContext.request.contextPath}/homepage/picture/  delete',
            data: str,
            success: function (e) {
                alert(e);
                window.location.reload()
